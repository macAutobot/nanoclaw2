...
To access plugin functionality, you first need to check that the plugin is exported and available by calling the <span class="title-ref">Engine.has_singleton()</span> function, which returns a registered singleton.
