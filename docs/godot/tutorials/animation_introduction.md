...
The `class_AnimationPlayer` node allows you to create anything from simple to complex animations.
...
To use the animation tools we first have to create an `class_AnimationPlayer` node.
...
<figure>
<img src="img/animation_create_animationplayer.webp" alt="The AnimationPlayer node" />
<figcaption aria-hidden="true">The AnimationPlayer node</figcaption>
</figure>

After you create an AnimationPlayer node, click on it to open the Animation Panel at the bottom of the viewport.

<figure>
<img src="img/animation_animation_panel.webp" alt="The animation panel position" />
<figcaption aria-hidden="true">The animation panel position</figcaption>
</figure>

The animation panel consists of four parts:

<figure>
<img src="img/animation_animation_panel_overview.webp" alt="The animation panel" />
<figcaption aria-hidden="true">The animation panel</figcaption>
</figure>
...
<figure>
<img src="img/animation_keyframes.webp" alt="Keyframes in Godot" />
<figcaption aria-hidden="true">Keyframes in Godot</figcaption>
</figure>
...
<figure>
<img src="img/animation_illustration.webp" alt="Two keyframes are all it takes to obtain a smooth motion" />
<figcaption aria-hidden="true">Two keyframes are all it takes to obtain a smooth motion</figcaption>
</figure>

The timeline defines how long the animation will take. You can insert keyframes at various points, and change their timing.

<figure>
<img src="img/animation_timeline.webp" alt="The timeline in the animation panel" />
<figcaption aria-hidden="true">The timeline in the animation panel</figcaption>
</figure>
...
<figure>
<img src="img/animation_normal_track.webp" alt="Example of Normal animation tracks" />
<figcaption aria-hidden="true">Example of Normal animation tracks</figcaption>
</figure>

> [!TIP]
> If you animate the wrong property, you can edit a track's path at any time by double-clicking on it and typing the new path. Play the animation using the "Play from beginning" button ![Play from beginning](img/animation_play_from_beginning.png) (or pressing `Shift + D` on keyboard) to see the changes instantly.
...
<figure>
<img src="img/animation_animation_player_tree.webp" alt="Our scene setup" />
<figcaption aria-hidden="true">Our scene setup</figcaption>
</figure>
...
Select the AnimationPlayer node and click the "Animation" button in the animation editor. From the list, select "New" (![Add Animation](img/animation_add.png)) to add a new animation. Enter a name for the animation in the dialog box.

<figure>
<img src="img/animation_create_new_animation.webp" alt="Add a new animation" />
<figcaption aria-hidden="true">Add a new animation</figcaption>
</figure>
...
<figure>
<img src="img/animation_library.webp" alt="Manage animations" />
<figcaption aria-hidden="true">Manage animations</figcaption>
</figure>

If there are multiple animation libraries and you try to add an animation, a dialog box will appear with options.

<figure>
<img src="img/animation_library_dialog.webp" alt="Add a new animation with library option" />
<figcaption aria-hidden="true">Add a new animation with library option</figcaption>
</figure>
...
<figure>
<img src="img/animation_convenience_buttons.webp" alt="Convenience buttons" />
<figcaption aria-hidden="true">Convenience buttons</figcaption>
</figure>
...
<figure>
<img src="img/animation_track.webp" alt="The sprite track" />
<figcaption aria-hidden="true">The sprite track</figcaption>
</figure>
...
<figure>
<img src="img/animation_set_length.webp" alt="Animation length" />
<figcaption aria-hidden="true">Animation length</figcaption>
</figure>
...
<figure>
<img src="img/animation_simple.gif" alt="The animation" />
<figcaption aria-hidden="true">The animation</figcaption>
</figure>
...
<figure>
<img src="img/animation_loop.webp" alt="Animation loop" />
<figcaption aria-hidden="true">Animation loop</figcaption>
</figure>
...
<figure>
<img src="img/animation_track_settings.webp" alt="Track settings" />
<figcaption aria-hidden="true">Track settings</figcaption>
</figure>
...
<figure>
<img src="img/animation_track_rate.webp" alt="Track mode" />
<figcaption aria-hidden="true">Track mode</figcaption>
</figure>
...
<figure>
<img src="img/animation_track_interpolation.webp" alt="Track interpolation" />
<figcaption aria-hidden="true">Track interpolation</figcaption>
</figure>
...
<figure>
<img src="img/animation_track_loop_modes.webp" alt="Loop modes" />
<figcaption aria-hidden="true">Loop modes</figcaption>
</figure>
...
<figure>
<img src="img/animation_properties_keyframe.webp" alt="Keyframes for other properties" />
<figcaption aria-hidden="true">Keyframes for other properties</figcaption>
</figure>
...
<figure>
<img src="img/animation_keyframe_editor_key.webp" alt="Keyframe editor editing a key" />
<figcaption aria-hidden="true">Keyframe editor editing a key</figcaption>
</figure>
...
To play the part of the animation between two markers use the `play_section_with_markers()<class_AnimationPlayer_method_play_section_with_markers>` and `play_section_with_markers_backwards()<class_AnimationPlayer_method_play_section_with_markers_backwards>` methods. If no start marker is specified then the beginning of the animation is used, and if no end marker is specified, then the end of the animation is used.
