...
With this clear, the aim of this tutorial section is to explain how to get the maximum performance out of Godot. While the tutorials can be read in any order, it is a good idea to start from `doc_general_optimization`.

## Common

<div id="toc-learn-features-general-optimization" class="toctree" maxdepth="1">
...
<div id="toc-learn-features-cpu-optimization" class="toctree" maxdepth="1">
...
<div id="toc-learn-features-gpu-optimization" class="toctree" maxdepth="1">
...
<div id="toc-learn-features-3d-optimization" class="toctree" maxdepth="1">
...
<div id="toc-learn-features-threads" class="toctree" maxdepth="1">
