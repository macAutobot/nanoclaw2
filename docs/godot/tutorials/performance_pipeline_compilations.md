...
<figure class="align-center">
<img src="img/pipeline_compilations_monitors.webp" alt="Screenshot of the Godot pipeline compilations monitor" />
<figcaption>Pipeline compilations of one of the demo projects.</figcaption>
</figure>
...
- **Normal and Roughness**: Enabled when using SDFGI, VoxelGI, screen-space reflections, SSAO, SSIL, or using the `normal_roughness_buffer` in a custom shader or `class_CompositorEffect`.
...
<figure class="align-center">
<img src="img/pipeline_compilations_hidden_node.webp" alt="Screenshot of an example of a hidden Node for an effect" />
<figcaption>Hidden bullet node attached to the player in one of the demo projects. This helps the engine precompile the effect's pipelines ahead of time.</figcaption>
</figure>
