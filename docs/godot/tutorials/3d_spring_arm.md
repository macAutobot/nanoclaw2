...
In Godot, this can be done by setting a `Camera3D <class_Camera3D>` as a child of a node. However, if you try this without any extra steps, you'll notice that the camera clips through geometry and hides the scene.
...
- <span class="title-ref">Node3D</span> (the "pivot point" for the camera)

  > - <span class="title-ref">SpringArm3D</span>
  >
  >   > - <span class="title-ref">Camera3D</span>
...
<div class="video" alt="Camera attached to a spring arm colliding with walls" autoplay="" loop="" muted="" align="default">
