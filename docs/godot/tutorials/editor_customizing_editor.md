...
<img src="img/editor_ui_resize_dock.webp" alt="Resizing a dock in the editor" />
<figcaption aria-hidden="true">Resizing a dock in the editor</figcaption>
</figure>
...
<figure class="align-center">
<img src="img/editor_ui_move_dock.webp" alt="Moving a dock in the editor" />
<figcaption aria-hidden="true">Moving a dock in the editor</figcaption>
</figure>
...
> - Useful editor settings or sections of the settings window that are relevant to customizing the interface.
> - Layouts
...
<figure class="align-center">
<img src="img/editor_ui_split_script_editor.webp" alt="Splitting the script editor to its own window" />
<figcaption aria-hidden="true">Splitting the script editor to its own window</figcaption>
</figure>

To split the shader editor to its own window, click the corresponding button in the top-right corner of the script editor:

<figure class="align-center">
<img src="img/editor_ui_split_shader_editor.webp" alt="Splitting the shader editor to its own window" />
<figcaption aria-hidden="true">Splitting the shader editor to its own window</figcaption>
</figure>
...
Editor layouts are saved to a file named `editor_layouts.cfg` in the configuration path of the `doc_data_paths_editor_data_paths`.
...
<figure class="align-center">
<img src="img/editor_settings.webp" alt="The Editor Settings window" />
<figcaption aria-hidden="true">The Editor Settings window</figcaption>
</figure>
...
See the `class_EditorSettings` class reference for a complete description of most editor settings. You can also hover an editor setting's name with the mouse in the Editor Settings to show its description.
