...
<figure>
<img src="img/particle_sub_chain.webp" alt="Chained sub-emitters" />
</figure>
...
<img src="img/particle_sub_assign.webp" alt="Assign sub-emitter" />
<figcaption>Click to assign a sub-emitter...</figcaption>
</figure>

<figure class="align-right">
<img src="img/particle_sub_list.webp" alt="List particle systems" />
...
When you assign a sub-emitter, you don't see it spawn right away. Emitting is disabled by default and needs to be enabled first. Set the `Mode` property in the `Sub Emitter` group of the `ParticleProcessMaterial <doc_process_material_properties_subemitter>` to something other than `Disabled`.
