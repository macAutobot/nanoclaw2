...
public override void <span id="process">Process</span>(double delta) { // Do something... }
...
public override void <span id="physicsprocess">PhysicsProcess</span>(double delta) { // Do something... }
...
public partial class CustomLabel : Label { private double <span id="time">time</span>;

> public override void <span id="process">Process</span>(double delta) { <span id="time">time</span> += delta; Text = <span id="time.tostring">time.ToString</span>(); // 'Text' is a built-in Label property. }
