...
<img src="img/importing_3d_scenes_available_formats_gltf_runtime.webp" alt="Diagram explaining the runtime import and export process for glTF files in Godot" />
</figure>
...
<figure class="align-center">
<img src="img/importing_3d_scenes_available_formats_gltf_editor.webp" alt="Diagram explaining the editor import process for glTF files in Godot" />
</figure>
...
<figure class="align-center">
<img src="img/importing_3d_scenes_available_formats_blend.webp" alt="Diagram explaining the import process for Blender files in Godot" />
</figure>
...
- Change their import mode to **OBJ as Scene** in the Import dock then restart the editor. This allows you to use the same import options as glTF or Collada scenes, such as unwrapping UV2 on import (for `doc_using_lightmap_gi`).
...
<figure class="align-center">
<img src="img/importing_3d_scenes_available_formats_fbx.webp" alt="Diagram explaining the import process for FBX files in Godot via FBX2glTF" />
</figure>

<div class="seealso">

The full installation process for using FBX2glTF in Godot is described on the [FBX import page of the Godot website](https://godotengine.org/fbx-import).
