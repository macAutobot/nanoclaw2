...
Enabling both options ensures the icon behaves as closely as possible to the stock editor icons. Read the guide for `creating icons <doc_editor_icons>` for more information.
