...
> [!NOTE]
> To code C# in an external editor, see `the C# guide to configure an external editor <doc_c_sharp_setup_external_editor>`.
...
<img src="img/editor_external_editor_settings.webp" alt="Text Editor &gt; External section of the Editor Settings" />
<figcaption aria-hidden="true"><strong>Text Editor &gt; External</strong> section of the Editor Settings</figcaption>
</figure>
...
Using external editor in debugger is determined by a separate option in settings. For details, see `Script editor debug tools and options <doc_debugger_tools_and_options>`.
