...
This page describes how to export a Godot project to iOS. If you're looking to compile export template binaries from source instead, read `doc_compiling_for_ios`.
...
Projects written in C# can be exported to iOS as of Godot 4.2, but support is experimental and `some limitations apply <doc_c_sharp_platforms>`.
...
> [!WARNING]
> Exporting for the iOS simulator is currently not supported as per [GH-102149](https://github.com/godotengine/godot/issues/102149).
>
...
Special iOS plugins can be used in Godot. Check out the `doc_plugins_for_ios` page.
...
You can find a full list of export options available in the `class_EditorExportPlatformIOS` class reference.
