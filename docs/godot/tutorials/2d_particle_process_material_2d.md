...
> [!NOTE]
> This page covers how to use ParticleProcessMaterial for 2D scenes specifically. For information on how to use it in a 3D scene see `doc_process_material_properties`.
...
> [!NOTE]
> Particle flipbook animation is only effective if the CanvasItemMaterial used on the GPUParticles2D or CPUParticles2D node has been `configured accordingly <doc_particle_systems_2d_using_flipbook>`.

To set up the particle flipbook for linear playback, set the **Speed Min** and **Speed Max** values to 1:

<figure class="align-center">
<img src="img/particles_flipbook_configure_animation_speed.webp" alt="Setting up particle animation for playback during the particle&#39;s lifetime" />
<figcaption aria-hidden="true">Setting up particle animation for playback during the particle's lifetime</figcaption>
</figure>
...
<figure class="align-center">
<img src="img/particles_flipbook_configure_animation_offset.webp" alt="Setting up particle animation for random offset on emission" />
<figcaption aria-hidden="true">Setting up particle animation for random offset on emission</figcaption>
</figure>
