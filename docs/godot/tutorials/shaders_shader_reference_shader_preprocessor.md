...
You can create new shader includes by using the **File \> Create Shader Include** menu option of the shader editor, or by creating a new `ShaderInclude<class_ShaderInclude>` resource in the FileSystem dock.
