...
<div id="toc-learn-workflow-assets-importing_3d_scenes" class="toctree" maxdepth="1">

available_formats model_export_considerations node_type_customization import_configuration advanced_import_settings

</div>

<div class="seealso">

3D scenes can be loaded at runtime using `runtime file loading and saving <doc_runtime_file_loading_and_saving_3d_scenes>`, including from an exported project.
